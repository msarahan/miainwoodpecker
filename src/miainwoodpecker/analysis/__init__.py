...
This package wires existing analysis tools (HyperSpy, py4DSTEM, LiberTEM)
in as thin adapters rather than reimplementing analysis code. The HyperSpy adapter
