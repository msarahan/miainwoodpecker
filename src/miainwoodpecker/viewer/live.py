...
class LiveInstrumentWidget(QtWidgets.QWidget):
    ...
    def _analyze_camera_in_libertem(self) -> None:
        ...
        def compute(source: _AnalysisInput) -> object:
            ...
            # overhead here. It is also what makes the in-memory
            # MemoryDataSet below the right dataset rather than a
            # testing convenience: there is no worker to ship the array
            # to (see the adapter's module docstring).
